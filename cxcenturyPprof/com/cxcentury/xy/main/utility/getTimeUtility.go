...
*/
//获取当前时间
func GetTimeUtility() (DateTimeStr string) {
...
func RuneDateUtilityToPath(DayNumber int64) (DateTime *string) {
	//rune截取字段
	str := string([]rune(time.Unix(time.Now().Unix(), 1000000000*60*60*24*DayNumber).String())[0:10])
	DateTime = &str
	return
}
